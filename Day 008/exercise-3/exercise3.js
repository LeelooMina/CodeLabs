...
function interview(arr, time){
    if (time > 120 || arr.length < 8){ //Test time and number of questions answered
        return "disqualified";
    }
    else if ( arr[0] > 5 || arr[1] > 5){ //Very easy questions
        return "disqualified";
    }
    else if ( arr[2] > 10 || arr[3] > 10){ //Easy questions
        return "disqualified";
    }
    else if ( arr[4] > 15 || arr[5] > 15){ //Medium questions
        return "disqualified";
    }
    else if ( arr[6] > 20 || arr[7] > 20){ //Hard questions
        return "disqualified";
    }
    else {
        return "qualified";
